...
export default function ProfileModal({open, isLoggedIn, handleLogin, handleLogout,  onClose}: ProfileModalProp) {
    if (!open) return;

    console.log("profile modal:", open);
    return (
        <div className="profile-modal-overlay" id="profileModal" onClick={() => onClose()}>
        <div className="profile-modal" onClick={(e) => {e.preventDefault();}}>
            ...
            {isLoggedIn && 
                ...
                <div className="profile-header">
                    ...
                    <div className="profile-info">
                        <div className="profile-name">Chess Master</div>
                        <div className="profile-email">player@leetchess.com</div>
                    </div>
                </div>
